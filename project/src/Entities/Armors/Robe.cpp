...
Robe::Robe(float x, float y, float w, float h, int lvl)
  ...
  switch (lvl) {
    ...
    case 1: {
      player_t.loadFromFile(FILES_PATH"files/images/halat_1.png");
      arm = 1;
      break;
    }

    case 2: {
      player_t.loadFromFile(FILES_PATH"files/images/halat_2.png");
      arm = 2;
      break;
    }

    case 3: {
      player_t.loadFromFile(FILES_PATH"files/images/halat_3.png");
      arm = 3;
      break;
    }

    case 4: {
      player_t.loadFromFile(FILES_PATH"files/images/halat_4.png");
      arm = 4;
      break;
    }
  }
