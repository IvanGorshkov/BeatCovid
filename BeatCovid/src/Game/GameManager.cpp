...
player(lvl.GetObject("player").rect, arms, config[0], 1, points) {
    ...
    labelManager.SetLabel("UnSafeTransportDmg", std::make_shared<GameLabel>(textSize, "Damaging", sf::Color::Red), CENTER_UP);
